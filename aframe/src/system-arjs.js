AFRAME.registerSystem('arjs', {
  ...
  init: function () {
    ...
    if (this.data.cameraParametersUrl !== '') {
      arProfile.contextParameters.cameraParametersUrl
    ...
    if (this.data.sourceElement !== -1) {
      arProfile.sourceParameters.sourceElement = this.data.sourceElement
    }
    ...
    this.el.sceneEl.addEventListener('renderstart', function () {
      ...
      //		build ARjs.Session
      //////////////////////////////////////////////////////////////////////////////
      arProfile.sourceParameters.sourceElement = document.querySelector(arProfile.sourceParameters.sourceElement) ||
                                                 document.body;
      ...
      if (arProfile.contextParameters.trackingBackend === 'tango') {
        ...
        renderer.render = function customRender(scene, camera, renderTarget, forceClear) {
          ...
          if (arProfile.contextParameters.trackingBackend === 'tango') {
            ...
            // render sceneOrtho
            rendererRenderFct.call(renderer, tangoVideoMesh._sceneOrtho, tangoVideoMesh._cameraOrtho, renderTarget,
              forceClear)
